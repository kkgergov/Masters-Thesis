...
def generate_hellinger_circuits():
    ...
    # Create ansatz and bind random values to the rotations
    var_qc = n_local(3, "ry", "cx", "linear", reps=2, insert_barriers=True)
    param_list = list(var_qc.parameters)
    var_qc = var_qc.assign_parameters(dict(zip(param_list, random_values00)))
    qc.append(var_qc, [0, 1, 2])
    ...
    param_list = list(var_qc.parameters)
    var_qc = var_qc.assign_parameters(dict(zip(param_list, random_values01)))
    qc.append(var_qc, [0, 1, 2, 3])
    # Finish up circuit and calculate theoretical perfect output dist
    true_dists.append(get_ideal_dist(qc))
    qc.measure([0, 1, 2, 3], [0, 1, 2, 3])
    ...
    param_list = list(var_qc.parameters)
    var_qc = var_qc.assign_parameters(dict(zip(param_list, random_values02)))
    qc.append(var_qc, [0, 1, 2, 3])
    # Finish up circuit and calculate theoretical perfect output dist
    true_dists.append(get_ideal_dist(qc))
    qc.measure([0, 1, 2, 3], [0, 1, 2, 3])
    ...
    param_list = list(var_qc.parameters)
    var_qc = var_qc.assign_parameters(dict(zip(param_list, random_values03)))
    qc.append(var_qc, [0, 1, 2, 3])
    # Finish up circuit and calculate theoretical perfect output dist
    true_dists.append(get_ideal_dist(qc))
    qc.measure([0, 1, 2, 3], [0, 1, 2, 3])
    ...
    param_list = list(var_qc.parameters)
    var_qc = var_qc.assign_parameters(dict(zip(param_list, random_values04)))
    qc.append(var_qc, [0, 1, 2, 3])
    # Finish up circuit and calculate theoretical perfect output dist
    true_dists.append(get_ideal_dist(qc))
    qc.measure([0, 1, 2, 3], [0, 1, 2, 3])
